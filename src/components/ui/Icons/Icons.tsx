...
function Studyverse(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <Link href="/">
...
function LogoutCircleLine(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1.5rem" height="1.5rem" {...props}>
      <path
        fill="currentColor"
...
export const Icons = { Logo: Studyverse, Logout: LogoutCircleLine, BackToHome: BaselineArrowCircleLeft };
